...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{>{\RaggedRight\arraybackslash}p{4.2cm}>{\RaggedRight\arraybackslash}p{4.1cm}Y}
    ...
    \path{/explore} & descoperire de proiecte & \texttt{authGuard}; punct de intrare în zona socială după autentificare \\
    ...
    \path{/:username} & profil propriu / al altor utilizatori & disponibil doar după autentificare; destinație implicită după încărcarea sesiunii \\
    \bottomrule
  \end{tabularx}
\end{table}
