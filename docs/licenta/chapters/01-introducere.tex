...
Pe partea de backend a fost urmărită o organizare apropiată de principiile prezentate în literatura de arhitectură software \cite{bass2021softwarearchitecture,martin2017cleanarchitecture}. Asta a însemnat separarea controllerelor de serviciile de aplicație și separarea logicii de business de infrastructură. Nu a fost urmărită o implementare rigidă, ci una suficient de clară încât proiectul să poată fi extins fără a deveni greu de urmărit.
