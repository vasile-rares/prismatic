...
\textbf{Utilizatorul neautentificat} poate accesa doar fluxurile de autentificare și recuperare a accesului. El nu poate intra în editor, nu poate vedea zona de explorare și nu poate accesa profilurile sau proiectele celorlalți utilizatori.
